...
PREFERENTIAL_JSON_PATH = os.path.join(DATA_DIR, "preferential_translations.json")  # TODO: cleanup - old method
TERMINOLOGY_JSON_PATH = os.path.join(DATA_DIR, "terminology.json")
