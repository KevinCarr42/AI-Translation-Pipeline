...
def test_training_hyperparams_defaults():
    """Verify TRAINING_HYPERPARAMS match FineTuning repo specifications"""
    import config
...
def test_quantization_config():
    """Verify QUANTIZATION_CONFIG matches finetune_all.py settings"""
    import config
...
def test_model_specific_hyperparams():
    """Verify MODEL_SPECIFIC_HYPERPARAMS match finetune_all.py"""
    import config
...
def test_models_config():
    """Verify MODELS config has all expected translation models"""
    import config
...
def test_data_paths():
    """Verify data path configuration is set correctly"""
    import config
